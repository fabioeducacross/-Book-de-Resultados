...
The `pro/` directory in aiox-core is a git submodule pointing to the aios-pro repository.
...
This ensures the submodule pointer in aiox-core references a valid commit in aios-pro.
...
| **aios-pro** | With aiox-core cloned | Integration (pro/ symlinked) | GitHub Packages |
