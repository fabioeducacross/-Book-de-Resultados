...
**IMPORTANTE**: Estes documentos agora estão no repositório `SynkraAI/aiox-core`. A migração do antigo org `aios/aiox-core` foi concluída em dezembro de 2024 como parte do OSR-9 (Rebranding).
