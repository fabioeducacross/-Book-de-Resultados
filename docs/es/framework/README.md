...
**IMPORTANTE**: Estos documentos ahora están en el repositorio `SynkraAI/aiox-core`. La migración desde la antigua organización `aios/aiox-core` se completó en diciembre de 2024 como parte del OSR-9 (Rebranding).
