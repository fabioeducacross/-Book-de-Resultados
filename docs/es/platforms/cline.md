...
### ¿Por qué usar AIOX con Cline?

Cline ofrece integración perfecta con VS Code para AIOX:
...
R: Ejecuta `npm run sync:agents` después de actualizaciones de AIOX.
...
_Synkra AIOX - Guía de Plataforma Cline v1.0_
