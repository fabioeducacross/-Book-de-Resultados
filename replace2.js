...
const b64 = Buffer.from(fs.readFileSync('star.png')).toString('base64');
const newImage = "url('data:image/png;base64," + b64 + "'), url('data:image/png;base64," + b64 + "')";
...
console.log('Done replacement with star.png');
